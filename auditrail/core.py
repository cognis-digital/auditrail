"""AUDITRAIL core — Tamper-evident audit-log aggregator with hash-chained attestation."""
...
RULES = [
    ("AUD-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("AUD-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("AUD-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
