"""AUDITRAIL command-line interface."""
from __future__ import annotations
import argparse, sys
from auditrail.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="auditrail", description="AUDITRAIL — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from auditrail.mcp_server import serve
        return serve()
    if args.cmd == "scan":
