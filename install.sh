#!/usr/bin/env sh
# Universal installer for auditrail. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/auditrail.git"
echo "Installing auditrail ..."
