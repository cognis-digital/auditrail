...
[![PyPI](https://img.shields.io/pypi/v/cognis-auditrail.svg)](https://pypi.org/project/cognis-auditrail/)
[![CI](https://github.com/cognis-digital/auditrail/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/auditrail/actions)
...
AUDITRAIL exists for one job — tamper-evident audit-log aggregator with hash-chained attestation — and does it without a SaaS bill or heavyweight setup.
...
```bash
auditrail --version
auditrail scan .                      # scan the current project
auditrail scan . --format json
auditrail scan . --fail-on high       # non-zero exit for CI gates
auditrail mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **audit logging**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`auditrail` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
